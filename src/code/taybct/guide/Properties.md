...
|taybct.secure.auth.login-page.redirect|Boolean|false|开启重定向到登录页面<Badge text="3.2.3" type="tip" vertical="top" />|
|taybct.secure.auth.login-page.login-page|String|base-login|默认的登录页面<Badge text="3.2.3" type="tip" vertical="top" />|
|taybct.secure.auth.login-page.redirect-login-page|String||重定向的地址<Badge text="3.2.3" type="tip" vertical="top" />|
|taybct.secure.auth.login-page.params-redirect-api|String||登录页面登录成功之后用于获取 code 的接口地址<Badge text="3.2.3" type="tip" vertical="top" />|
|taybct.secure.auth.login-page.params-redirect-api-encode-type|String|uri_component|前端获取参数需要加密的 url 加密类型<Badge text="3.2.3" type="tip" vertical="top" />|
|||||
