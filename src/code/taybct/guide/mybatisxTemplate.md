...
- [通用模板（3.2.x 持续更新）](https://jihulab.com/mangocrisp/spring-taybct/-/tree/3.2.x/spring-taybct-common/src/main/resources/MybatisX/Controller-Service-Mapper-MP3)
- [通用模板（2.7.x）](https://jihulab.com/mangocrisp/spring-taybct/-/tree/2.7.x/spring-taybct-common/src/main/resources/MybatisX/Controller-Service-Mapper-MP3)
