...
- [通用模板（3.2.x 持续更新）](https://gitee.com/mangocrisp/spring-taybct/-/tree/3.2.x/spring-taybct-common/src/main/resources/MybatisX/templates)
- [通用模板（2.7.x）](https://gitee.com/mangocrisp/spring-taybct/-/tree/2.7.x/spring-taybct-common/src/main/resources)
